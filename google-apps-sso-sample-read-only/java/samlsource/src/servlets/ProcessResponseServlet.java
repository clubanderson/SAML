...
/****************************************************************/
//BEGIN: PARTNER WILL HAVE THEIR OWN LOGIN PROCEDURE
/****************************************************************/
...
/****************************************************************/
  ...
  private String decodeAuthnRequestXML(String encodedRequestXmlString) 
    ...
    try {
      ...
      //base64DecodedByteArray = decode(encodedRequestXmlString);
      //return decode(encodedRequestXmlString);

//byte[] decoded = Base64.decodeBase64(encodedRequestXmlString);    
//    byte[] decoded = Base64.decodeBase64(encodedRequestXmlString);
//    decodedRequestXmlString = new String(decoded, "UTF-8");

//      return(decodedRequestXmlString);
      // URL decode
      ...
      String decoded = new String(base64DecodedByteArray, "UTF-8");
      return (decoded);

//      if (true) {
//        throw new RuntimeException(encodedRequestXmlString);
//      }
...
//    String samlResponse = Util.readFileContents(filepath);
    ...
    String samlResponse = "";
    String path="/templates/" + samlResponseTemplateFile;
    InputStream inputStream = this.getServletConfig().getServletContext().getResourceAsStream(path);
    try{
      samlResponse = convertStreamToString(inputStream, 1024, "UTF-8");
    }catch(IOException e){
      e.printStackTrace();
    } 
   ...
   * to the identity_provider2.jsp file, which is included in Google's SAML
 ...
 //    String issueInstant = "2013-08-14T03:47:12Z";
//      String providerName = "www.myvrm.com";
  //      String acsURL = "http://testpilot1.myvrm.com/samlacs.aspx";
   //     String requestId = "peoghmilhneadfipjoleknejlcdpggfojefobgpl";

    String returnPage = "./identity_provider2.jsp";
...
pw.println("\n\nThe decoded SAML Request reads as follows (watch for a missing close tag - if so, re-encode and try again</br>");
pw.println();
pw.println(requestXmlString);
...
//        request.setAttribute("username", username);
  ...
  //      } else {
          ...
          //DSAPublicKey publicKey = (DSAPublicKey) inputStreamPub;
          //DSAPrivateKey privateKey = (DSAPrivateKey) inputStreamPriv;
          ...
          if (continueLogin) {
            ...
            String responseXmlString = createSamlResponse("", notBefore,
