...
public class CreateRequestServlet extends HttpServlet {
  ...
  private String createAuthnRequest(String acsURL, String providerName)
    ...
    //getServletContext().getRealPath("templates/" + AUTHN_REQUEST_TEMPLATE); */
 
    String authnRequest = "";
    String path="/templates/" + AUTHN_REQUEST_TEMPLATE;
    InputStream inputStream = this.getServletConfig().getServletContext().getResourceAsStream(path);
    try{
      authnRequest = convertStreamToString(inputStream, 1024, "UTF-8");
    }catch(IOException e){
      e.printStackTrace();
    } 
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response)
    ...
    String ssoURL = "./ProcessResponseServlet";   /* TODO myVRM: this is the location of the servlet on the partner site url */
...
/****************************************************************/
    ...
    String providerName = "myvrm.com";           /* TODO myVRM: this should be changed to myvrm.com */
    String domainName = "";        /* TODO myVRM: this should be changed to partner domain name */
    String relayStateURL = "http://testpilot1.myvrm.com/" + domainName;  /* TODO myVRM: this should be changed to final destination home page: http://csm.myrm.com/a/ */
    String acsURI = "http://testpilot1.myvrm.com/SAMLACS.aspx";  /* TODO myVRM: this should be changed to myVRM acs location: http://csm.myrm.com/a/ */
/****************************************************************/
//BEGIN: END
/****************************************************************/
