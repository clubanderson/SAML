...
<body>
  ...
  <%
    ...
    String domainName = "www.myvrm.com";
  ...
  <%
      ...
      <form name="IdentityProviderForm" action="ProcessResponseServlet" method="post">
        ...
        <!-- Comment out the following four lines in Stage II -->
        <blockquote>
        ...
        <p>Click the <b>Generate SAML Response</b> button. A SAML response 
        indicating that the user (demouser@psosamldemo.net) is authorized to 
        reach the CSM service is generated. When you click the <b>Generate SAML 
